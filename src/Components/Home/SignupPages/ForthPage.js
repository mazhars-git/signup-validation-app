        ...
        <div className="step-four-box">
            ...
            <div className='box-content default-content d-flex gap-3 mb-3 align-items-start'>
                ...
                <div>
                    ...
                    <p className='m-0'>A licensed social worker, Anne began over-drinking to block out humiliation, anxiety, loss and to manage anger during a financial downfall and difficult divorce from a 25 year relationship. Anne was introduced to the world of Harm Reduction after the tragic death of her nephew from an overdose. Helping others regain hope, resilience, purpose, and navigating loss of all kinds became her passion.</p>
                    <h4>Timezone: UK</h4>
                </div>                
            </div>
            ...
            <div className='box-content default-content d-flex gap-3 mb-3 align-items-start'>
                ...
                <div>
                    <h4 style={{color: '#0967AF'}}>Can't Decide?</h4>
